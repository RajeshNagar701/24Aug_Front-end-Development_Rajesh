                    ...
                    <div className="col-lg-8">
                        ...
                        <div className="mb-5">
                            ...
                            <div className="d-flex mb-4">
                                <img src="img/user.jpg" className="img-fluid" style={{ width: 45, height: 45 }} />
                                <div className="ps-3">
                    ...
                    <div className="col-lg-4">
                        ...
                        <div className="mb-5">
                            ...
                            <div className="d-flex flex-column justify-content-start">
                                <a className="h5 bg-light py-2 px-3 mb-2" href="#"><i className="bi bi-arrow-right me-2" />Web Design</a>
                                <a className="h5 bg-light py-2 px-3 mb-2" href="#"><i className="bi bi-arrow-right me-2" />Web Development</a>
                                <a className="h5 bg-light py-2 px-3 mb-2" href="#"><i className="bi bi-arrow-right me-2" />Web Development</a>
                                <a className="h5 bg-light py-2 px-3 mb-2" href="#"><i className="bi bi-arrow-right me-2" />Keyword Research</a>
                                <a className="h5 bg-light py-2 px-3 mb-2" href="#"><i className="bi bi-arrow-right me-2" />Email Marketing</a>
                            </div>
                        </div>
                        {/* Category End */}
                        {/* Recent Post Start */}
                        <div className="mb-5">
                            ...
                            <div className="d-flex overflow-hidden mb-3">
                                ...
                                <a href className="h5 d-flex align-items-center bg-light px-3 mb-0">Lorem ipsum dolor sit amet adipis elit
                                </a>
                            </div>
                            <div className="d-flex overflow-hidden mb-3">
